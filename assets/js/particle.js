...
function launchParticlesJS(cvs, params){

  var canvas_el = document.querySelector('#'+cvs+' > canvas');
...
window.particlesJS = function(cvs, params){
  ...
  /* append canvas */
  var canvas = document.getElementById(cvs).appendChild(canvas_el);

  /* launch particle.js */
  if(canvas != null){
    launchParticlesJS(cvs, params);
  }
